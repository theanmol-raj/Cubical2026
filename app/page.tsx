...
export default function LandingPage() {
  ...
  const getDashboardContent = () => {
    switch (activeCard) {
      case 0:
        return <div className="text-[#828387] text-sm">SaaS MVP Development - From Idea to Launch</div>
      case 1:
        return <div className="text-[#828387] text-sm">AI SaaS Development - Intelligent Solutions</div>
      case 2:
        return <div className="text-[#828387] text-sm">Scaling & Growth - Take Your Product to Market</div>
      default:
        return <div className="text-[#828387] text-sm">SaaS MVP Development - From Idea to Launch</div>
    }
  }
      ...
      <div className="relative flex flex-col justify-start items-center w-full">
        ...
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            ...
            {/* Hero Section */}
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[175px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <div className="w-full max-w-[748.71px] lg:w-[748.71px] text-center flex justify-center flex-col text-[#37322F] text-[24px] xs:text-[28px] sm:text-[36px] md:text-[52px] lg:text-[80px] font-normal leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-24 font-serif px-2 sm:px-4 md:px-0">
                    We Build SaaS Products for Founders From Idea to Market
                  </div>
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    We help founders go from 0→1 and scale from 1→market with custom SaaS, AI-driven products, and
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start mt-8 md:mt-10 lg:mt-12">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  <FeatureCard
                    ...
                    description="From idea to launch-ready product with authentication, dashboards, and core features built for validation."
                  ...
                  <FeatureCard
                    ...
                    description="AI copilots, chatbots, and automation tools that actually ship and work powered by cutting-edge AI technology."
                  ...
                  <FeatureCard
                    ...
                    description="Feature expansion, performance optimization, and scalability for startups ready to grow from 1 to market."
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="w-full max-w-[472.55px] text-center flex justify-center flex-col text-[#49423D] text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
                      Building a SaaS Is Hard We Make It Easy
                    </div>
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Finding reliable developers is painful. MVPs take too long.
                      <br className="hidden sm:block" />
                      We help founders ship products faster without the usual agency headaches.
                    </div>
                  </div>
                </div>
