...
export const CALENDAR_LINK = "https://calendar.google.com/calendar/appointments/schedules/YOUR_SCHEDULE_ID"
      ...
      <div className="max-w-[1060px] mx-auto px-4">
        <nav className="flex items-center justify-between py-4">
          <div className="flex items-center space-x-8">
            <div className="text-[#37322f] font-semibold text-lg">Cubical</div>
          ...
          <a href={CALENDAR_LINK} target="_blank" rel="noopener noreferrer">
            <Button className="bg-[#37322f] hover:bg-[#37322f]/90 text-white">Book Call</Button>
          </a>
        </nav>
      </div>
    </header>
