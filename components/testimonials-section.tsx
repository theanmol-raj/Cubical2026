...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "They took our idea from concept to MVP in just 8 weeks. The product is clean, scalable, and our users love it. Best decision we made.",
      name: "Sarah Chen",
      company: "Founder, DataFlow AI",
      image: "/images/chatgpt-20image-20sep-2011-2c-202025-2c-2010-54-18-20am.png",
    },
    {
      quote:
        "Working with this team felt like having a technical co-founder. They understood our vision and built exactly what we needed to validate our market.",
      name: "Marcus Rodriguez",
      company: "Co-founder, FinTech Startup",
      image: "/images/chatgpt-20image-20sep-2011-2c-202025-2c-2011-01-05-20am.png",
    },
    {
      quote:
        "We needed AI integration for our SaaS platform. They delivered a production-ready solution that actually works no over-engineering, just results.",
      name: "Jamie Marshall",
